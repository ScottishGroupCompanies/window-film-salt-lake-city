# LLumar Product Page Spec

## Inputs
- **Brand:** LLumar (Eastman Chemical Company)
- **Slug:** `llumar`
- **URL:** `/products/llumar/`
- **CSS prefix:** `ll-`
...
## Institutional Quote
Use IWFA or LLumar manufacturer language. Format: `"[text]," according to [Source].`
...
- `llumar-testimonial-marcus-t.jpg` (1024×1024)
- `llumar-testimonial-rachel-w.jpg` (1024×1024)
- `llumar-testimonial-robert-h.jpg` (1024×1024)
