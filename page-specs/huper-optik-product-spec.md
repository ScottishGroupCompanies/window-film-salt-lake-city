# Huper Optik Window Film — Product Page Spec
**File:** `src/pages/products/huper-optik.astro`
**URL:** `/products/huper-optik/`
**CSS prefix:** `ho-`
**Built:** 2026-07-23
...
- **Full name:** Hüper Optik™ (use "Huper Optik" without umlaut in page copy for SEO)
- **Owner:** Eastman Chemical Company (same parent as LLumar and Vista)
- **Flagship tech:** Patented dual-layer Titanium Nitride (TiN) ceramic coating — US patent awarded
- **Key differentiator:** 100% metal-free ceramic — no signal interference (Wi-Fi, GPS, cellular, keyfobs)
- **Signal safety quote:** Use this in Why section: "The ceramic composition ensures no interference with wireless signals, GPS, or electronic key fobs," according to Huper Optik.
- **Heritage:** Named after Joseph von Fraunhofer (1787–1826), German optics pioneer

---

## Product Lines (5 rows — from verified spec sheets)

### Row 1 — Ceramic Series (flagship, image LEFT)
- **Tech:** Dual-layer Titanium Nitride (TiN), US-patented, 100% metal-free ceramic
...
- **Tech:** High-performance solar control, dual-layer construction
- **Key specs (Sech):** VLT 59% · SHGC 0.46 · IR rejection 83% · UV 99%
...
| Stat | Value | Label |
|---|---|---|
| UV Rejection | 99 | % UV Block |
| IR Rejection | 83 | % IR Rejection |
| VLT Range | 5 | –85% VLT Range |
| Warranty | 15 | yr Commercial |
...
- "for museums and historic buildings"
...
|---|---|---|---|---|---|
| Ceramic C40 | Huper Optik | 42% | 54% TSER | 99% | Lifetime res / 15yr com |
| Ceramic C70 | Huper Optik | 71% | 35% TSER | 99% | Lifetime res / 15yr com |
| Select Sech | Huper Optik | 59% | ~54% | 99% | Lifetime res / 15yr com |
| Prestige 70 | 3M | 70% | 57% | 99.9% | 15yr commercial |
| ATC Series | LLumar | 5–80% | Up to 78% | 99% | Lifetime res / 15yr com |
| Sunscape | Madico | Light–Medium | Up to 86% | 99% | Lifetime res / 15yr com |

Source: Manufacturer published spec sheets; IWFA industry standards.
...
| Testimonial 4 | `huper-optik-testimonial-sofia.jpg` | 1024×1024 |
| Testimonial 5 | `huper-optik-testimonial-kevin.jpg` | 1024×1024 |
| Testimonial 6 | `huper-optik-testimonial-priya.jpg` | 1024×1024 |

**CSS prefix `ho-` applies to CSS classes ONLY — NEVER in image filenames.**
