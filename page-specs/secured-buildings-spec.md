# Secured Buildings Window Film — Page Spec
...
2. **Forced Entry Delay** — 8–15 mil security film with attachment systems delays sustained intrusion attempts at entry glass, sidelites, and vulnerable glazing
3. **Ballistic Resistance (C-Bond BRS)** — multi-layer PET ballistic systems with C-Bond Secure primer; delays projectile penetration — NOT bulletproof, but a retrofit alternative to ballistic glass
4. **Solar Control & Privacy** — security film with solar-control properties; one-way daytime privacy for sensitive operations; UV rejection protects equipment and documents

## Space Type Cards (6 — same grid pattern as office.astro)
- Card 1 (hero): Secured Entry & Lobby — icon + long paragraph + pill tag (NO photo)
- Card 2 (photo): Data Center & Server Room
- Card 3 (photo): Teller Area & Cash Counting
- Card 4 (dark): Police Station & Evidence Room — dark card with icon + accent line + micro-pill
- Card 5 (dark-pattern): Federal Facility & Courthouse — dark pattern card with icon + micro-pill
- Card 6 (badge): Military & Critical Infrastructure — photo badge card with badge pill overlay

## Film Type Slider (6 slides)
1. Blast Mitigation Film — ASTM F1642, GSA TS01 context
2. Security & Anti-Intrusion Film — 8–15 mil, delayed entry, attachment systems
3. Ballistic-Resistant Film System (C-Bond BRS) — multi-layer PET + primer, UL 752 context
4. Solar Control Security Film — heat + UV + glare combined with security
5. Privacy & One-Way Mirror Film — daytime privacy for sensitive operations
...
2. Can window film meet GSA blast mitigation standards for federal buildings?
3. How does security film delay forced entry at secured building entries?
4. Is ballistic-resistant window film the same as bulletproof glass?
5. What is C-Bond BRS and how does it enhance glass security?
6. Can security film be combined with access control and alarm systems?
7. What thickness of security film do secured buildings need?
8. Does security window film affect the appearance of a secured facility?
9. Can window film be installed on existing single-pane glass in historic government buildings?
10. What warranty and certification comes with high-security film installations?
...
13. sb-gallery4.jpg (848×1264) — C-Bond primer application on glass surface
