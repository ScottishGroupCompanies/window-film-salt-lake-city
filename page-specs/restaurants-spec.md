...
| Safety slide | `/benefits/safety-and-security/` | `safety and security film` |

Rule: 4–6 contextual links. No URL repeated. Each must feel natural.

### External links (verify before publishing)
- `https://www.epa.gov/sunsafety/uv-index-scale-1` — EPA UV Index, anchor: "UV radiation" ✅ verified 200
- `https://www.osha.gov/ergonomics` — OSHA ergonomics/glare, anchor: "OSHA ergonomic guidelines" ✅ verified 200
- `https://www.eia.gov/energyexplained/use-of-energy/commercial-buildings.php` — EIA Commercial Energy, anchor: "U.S. Energy Information Administration" ✅ verified 200

---

## Content Policy (MANDATORY)
- ❌ NO installation time estimates
- ❌ NO per-sq-ft prices
- ❌ NO specific dollar savings
- ❌ NO automotive content
- ✅ Discuss factors that affect time/cost
- ✅ Use percentages with DOE/EPA citations (79% heat, 99% UV, 70% glare)

---

## Benefit Row Selection (4 rows — restaurant-specific)
Restaurants' top 4 concerns: (1) glare ruining dinner service, (2) energy costs, (3) ambiance/atmosphere, (4) protecting expensive furnishings from UV fading.

| Row | Benefit | Image | Layout |
|---|---|---|---|
| 1 | **Glare Reduction** | `rt-glare.jpg` | img left, text right |
| 2 | **Energy Savings** | `rt-energy.jpg` | text left, img right |
| 3 | **Privacy & Atmosphere** | `rt-privacy.jpg` | img left, text right |
| 4 | **UV Protection** | `rt-uv.jpg` | text left, img right |
...
- Problem 4: Street-level glass vulnerable to graffiti and smash-and-grab on high-foot-traffic corridors
- Image: `rt-why.jpg` (1376×768)

### 5. BENTO BAND (of-bento CSS)
4 stat tiles:
- "70%+" / Reduction in solar glare during peak dinner service
- "99%" / UV rays blocked — protecting upholstery, artwork, and flooring
- "79%" / Solar heat gain reduced through treated glass
- "< 3%" / Visible light change with high-VLT 3M Prestige films

### 6. SPACE TYPES GRID (of-spaces CSS, 4 cards)
- **Fine Dining** — `rt-type-fine-dining.jpg` — Upscale restaurants, tasting menus, white tablecloths
- **Casual & Family Dining** — `rt-type-casual.jpg` — Neighborhood bistros, BYOB spots, family restaurants
- **Cafes & Coffee Shops** — `rt-type-cafe.jpg` — All-day cafes, morning rush, laptop-friendly spaces
- **Bars & Lounges** — `rt-type-bar.jpg` — Cocktail bars, wine bars, late-night venues

### 7. BENEFIT ROWS (4 rows — restaurant-appropriate)

**Row 1 — Glare Reduction (img left)**
- H2: `Stop Losing Tables to Sunset Glare`
- 2 paragraphs: West-facing windows during 5–8pm service; guests requesting moves, tables going empty; 3M Prestige 70 blocks 70%+ glare while transmitting 70% of visible light; Color Rendering Index stays above 90 so plate presentation looks natural
- 3 bullets: Eliminates "can I move?" requests during dinner / High-VLT film keeps dining room bright and airy / Works on all orientations — west, south, east morning glare
- Internal link: `glare reduction window film` → `/benefits/glare-reduction/`
...
3 real Q&A items per slide — restaurant-specific.

**Slide 1 — Solar Control Film** (`rt-slider-solar.jpg`)
- Film name: Solar Control / 3M Prestige Series
...
**Slide 2 — Decorative & Privacy Film** (`rt-slider-privacy.jpg`)
- Film name: Decorative / 3M Fasara Series
- Q1: We want frosted glass partitions between dining sections. Can film do that?
  A1: Absolutely. 3M Fasara decorative films come in hundreds of patterns and apply directly to existing glass. You can create private dining areas without structural changes or new glass walls.
- Q2: Can we put our logo or a custom pattern on the glass?
  A2: Yes. Printed decorative film can be cut to any shape — popular for front windows, host stand glass, and wine room dividers. It removes cleanly without damaging glass when you rebrand.
- Q3: We want some privacy at street level without blocking natural light above.
  A3: Dual-zone application: frosted on the lower 4 feet (pedestrian eye level) with clear or solar control film above. You get privacy where it matters while keeping the upper portion bright and open.

**Slide 3 — Safety & Security Film** (`rt-slider-security.jpg`)
- Film name: Safety & Security / 3M Scotchshield Ultra Series
- Q1: We've had incidents with glass breakage in the dining room. Is security film obvious?
  A1: Clear safety films are completely invisible — guests can't tell it's there. 3M Scotchshield Ultra S800 holds glass shards in place if breakage occurs from accidents, severe weather, or forced entry.
- Q2: Does safety film help with smash-and-grab at the bar?
  A2: Yes. Safety film dramatically slows forced entry by holding the glass intact even after it cracks. It's especially relevant for street-level bars, wine displays, and POS areas near the entrance.
- Q3: Do we need to treat all windows or just the vulnerable ones?
  A3: Most restaurants prioritize street-facing windows and doors, wine room glass, and POS stations. We assess your space and recommend targeted coverage — not every pane needs the same film.
- Internal link: `safety and security film` → `/benefits/safety-and-security/`

**Slide 4 — Anti-Graffiti Film** (`rt-slider-antigraffiti.jpg`)
- Film name: Anti-Graffiti / Sacrificial Film
- Q1: We're on a high foot-traffic street and we've had tagging issues. What's the solution?
  A1: Sacrificial anti-graffiti film acts as a removable protective layer. If someone tags your glass, we peel and replace the film — no acid-washing or costly glass replacement. Your windows look new every time.
- Q2: Does anti-graffiti film affect clarity from inside the dining room?
  A2: The optical clarity is nearly identical to bare glass. Guests dining near the windows can't tell the difference, and the exterior appearance is unchanged.
- Q3: How often does anti-graffiti film need to be replaced?
  A3: In clean environments, 5–7 years. On high-traffic corridors like South Street or Frankford Ave, replacement depends on incidents — but each swap takes about 15 minutes and costs a fraction of glass restoration.
...
- Q3: What's the difference between Low-E film and standard solar control film?
  A3: Standard solar control film addresses summer heat and UV. Low-E film (like 3M Thinsulate CC75) also improves thermal performance in winter by reflecting interior heat back into the space — higher ROI for restaurants with year-round glass exposure.

**Slide 6 — Daylight Redirecting Film** (`rt-slider-daylight.jpg`)
- Film name: Daylight Redirecting / 3M DRF
- Q1: Our dining room gets harsh direct sun in the morning. Can film soften it?
  A1: That's exactly what 3M Daylight Redirecting Film is designed for. It redirects direct sunlight up toward the ceiling, distributing it as soft diffused light — no harsh shafts, no dark spots, and no artificial lighting needed at midday.
...
### 11. RESOURCES
Case study PDFs FIRST, then spec sheets:
| Label | PDF filename | Description |
|---|---|---|
| `3M Case Study — Markthal Food Market` | `3m-markthal-food-market-window-film-case-study.pdf` | Window film in a major food market venue |
| `3M Energy Efficiency Brochure` | `3m-commercial-window-film-energy-efficiency-brochure.pdf` | Commercial window film energy savings data |
| `3M Prestige 70 Spec Sheet` | *(existing in public/resources or link)* | Solar control product data |
| `3M Fasara Decorative Film Guide` | *(existing in public/resources or link)* | Decorative film product overview |
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Window film works by selectively filtering the solar spectrum — blocking the infrared (heat) and ultraviolet (UV) wavelengths while transmitting visible light. High-VLT solar control films like 3M Prestige 70 reduce glare by 70%+ while still transmitting 70% of visible light, so the dining room stays bright without the harsh squinting effect from direct sun."
  },
  {
    question: "Will window film change how my restaurant looks from the outside?",
    answer: "The visual change depends on the film type. Clear safety and low-VLT solar control films are nearly invisible from outside. High-VLT solar films have a very subtle tint. Decorative films (like frosted Fasara) are visible by design. We choose film that fits your aesthetic goals — we'll show you exterior samples before any work begins."
  },
  {
    question: "Can restaurant window film reduce energy bills?",
  ...
  {
    question: "Is window film safe around food service areas and kitchens?",
    answer: "Yes. Window film is a passive product — once installed and cured, it doesn't off-gas, shed particles, or interact with food service environments. Film is applied to glass surfaces in dining areas, private rooms, and storefronts, not in food preparation zones. The curing process takes 24–48 hours during which dining can continue normally."
  },
  {
    question: "How long does restaurant window film last?",
    answer: "Quality commercial window film typically lasts 10–15 years under normal restaurant conditions. Longevity depends on the film type, sun exposure, and cleaning practices. We recommend non-abrasive cleaning products and soft cloths; harsh chemicals or abrasive scrubbers can degrade the film coating over time. All installations come with manufacturer warranty documentation."
  },
  {
    question: "Does window film qualify for energy efficiency incentives or tax credits?",
...
const pageSchemas = [
  ...
  },
  {
    ...
    "speakable": {
      ...
      "cssSelector": [".of-hero h1", ".of-whatis h2", ".swt-faq"]
    }
  },
  {
    "@context": "https://schema.org",
  ...
  },
  {
    ...
    "review": [
      {
        "@type": "Review",
        "author": { "@type": "Person", "name": "Marco D." },
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" },
        "reviewBody": "The west-facing windows were killing our dinner service. Guests kept asking to move tables. After the film, not a single complaint — and our AC bill dropped noticeably by August."
      },
      {
        "@type": "Review",
        "author": { "@type": "Person", "name": "Sarah K." },
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" },
        "reviewBody": "We did the frosted lower panels and it completely transformed how the space feels from the street. More people come in because they can see we're busy, without feeling on display once they're seated."
      },
      {
        "@type": "Review",
        "author": { "@type": "Person", "name": "James R." },
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" },
        "reviewBody": "Three years in and the film on our storefront still looks perfect. No scratches, no peeling. And we haven't had a single graffiti incident since we put the sacrificial layer on the street-level glass."
      }
    ]
  }
];
...
- [ ] faqItems: exactly 10 items ✓
- [ ] pageSchemas: exactly 4 objects ✓
- [ ] speakable.cssSelector: ".of-hero h1" (check actual H1 class in cloned file)
- [ ] Product.review: 3 entries matching Marco D., Sarah K., James R.
- [ ] No inline script[type=application/ld+json]
- [ ] dateModified: new Date().toISOString().slice(0,10) in frontmatter
- [ ] Nav menu updated: add "Restaurants" link in Header.astro
